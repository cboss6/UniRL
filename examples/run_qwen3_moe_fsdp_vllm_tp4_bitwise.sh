...
export UNIMATCH_GATE_PROVIDER=${UNIMATCH_GATE_PROVIDER:-vllm_bi}
...
export UNIMATCH_ROUTER_SOFTMAX_PROVIDER=${UNIMATCH_ROUTER_SOFTMAX_PROVIDER:-vllm_bi}
export UNIMATCH_BATCH_INVARIANT_NORM=1
export UNIMATCH_RMSNORM_PROVIDER=${UNIMATCH_RMSNORM_PROVIDER:-vllm_bi}
export UNIMATCH_RMSNORM_BACKWARD_PROVIDER=${UNIMATCH_RMSNORM_BACKWARD_PROVIDER:-torch}
